...
{   
    ...
    while(dec >=0){                                 //Run until a negative decimal number is entered
        ...
        if (dec <0){                                //Quit program and display EXIT if decimal number is negative
            ...
            log = log2(dec)/log2(rad);                                          //Calculate number of bits required to display number in a different radix using log function
            printf("\nThe log%d of the number is %.2f ",rad,log);               //Display the number of bits required
            ...
            printf("\nThe radix-%d value is ",rad);                             //Display the eqivalent radix-i value
